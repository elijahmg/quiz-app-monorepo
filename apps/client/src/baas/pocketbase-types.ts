...
export type QuestionResponse<Texpand = unknown> = Required<QuestionRecord> & BaseSystemFields<Texpand>
export type QuizResponse<Texpand = unknown> = Required<QuizRecord> & BaseSystemFields<Texpand>
export type QuizStatusResponse<Texpand = unknown> = Required<QuizStatusRecord> & BaseSystemFields<Texpand>
...
export type TeamAnswersResponse<Texpand = unknown> = Required<TeamAnswersRecord> & BaseSystemFields<Texpand>
