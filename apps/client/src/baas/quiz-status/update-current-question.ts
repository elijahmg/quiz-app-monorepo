...
export async function updateCurrentQuestion({ newCurrentQuestionId, quizStatusId }: Args) {
  const updatedQuizStatus = await db.quizStatus().update<QuizStatusResponse>(quizStatusId, {
