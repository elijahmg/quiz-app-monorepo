...
import { IS_QUIZ_EXIST_BY_PIN_API_KEY, isQuizExistByPin } from '@/baas/quiz/is-quiz-exist-by-pin';
...
function App(): JSX.Element {
  ...
  return (
    <div
      className="lg:grid-cols-2 sm:flex lg:grid items-center justify-center h-[100vh] max-w-screen-xl sm:m-4 lg:mx-auto">
      <div className="space-y-4 justify-self-center">
        ...
        <div className="space-x-4">
          <Button disabled={isPending} onClick={() => checkIsQuizExistByPin(clientPin)}>Enter the game!</Button>
        </div>
      </div>
      <div className="space-y-4 justify-self-center">
